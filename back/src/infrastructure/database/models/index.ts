...
import { PrescriptionHealthcareAct } from './PrescriptionHealthcareAct.model';
...
export const initModels = () => {
  ...
  return { User, Patient, HealthcareProfessional, HealthcareAct, Appointment, Structure, Prescription };
};
